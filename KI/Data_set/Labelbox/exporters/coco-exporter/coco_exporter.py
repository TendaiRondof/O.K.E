...
def add_label(
    ...
    """
    file_name = "Image"+str(len(listdir("Data_set/Images/")))+".jpg"
    image = {
        "id": label_id,
        "file_name": file_name,
        "license": None,
    ...
    try:
        ...
        cv2.imshow("fisch",opencvImage)
        if cv2.waitKey(1) & 0xFF == ord('q'):
            exit()

        cv2.imwrite('Data_set/Images/{}.jpg'.format(label_id),opencvImage)
