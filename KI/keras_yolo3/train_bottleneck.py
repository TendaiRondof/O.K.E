...
def _main():
    ...
    log_dir = prefix+'logs/000/'
    classes_path = prefix+'model_data/coco_classes.txt'
    anchors_path = prefix+'model_data/yolo_anchors_tiny.txt'
    ...
    model, bottleneck_model, last_layer_model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path=prefix+'model_data/yolo_tiny.h5') # make sure you know what you freeze
